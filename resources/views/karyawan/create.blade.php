            ...
            <form action="{{ route('karyawans.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="date" class="form-control @error('doh') is-invalid @enderror" id="doh" name="doh" value="{{ old('doh') }}">
                        @error('doh')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('poh') is-invalid @enderror" id="poh" name="poh" value="{{ old('poh') }}">
                        @error('poh')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                            ...
                            <option value="Non Staff" {{ old('status') == 'Non Staff' ? 'selected' : '' }}>Non Staff</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
